...
const details: Record<string, Detail> = {
  "insight-funders": {
    ...
    overview: ["Insight Funders is a business-finance marketplace that helps companies explore funding options. Conscious Rise developed the public-facing experience in Framer, turning a dense financial proposition into a clear journey for business owners."],
  ...
  "elysium-communities": {
    ...
    overview: ["Elysium Communities presents a new model of community-led experiential real estate. The work covered its Webflow customer experience and custom application flows, connecting a visually rich marketing site with application logic built outside Webflow."],
  ...
  "leafy-plate": {
    ...
    overview: ["Leafy Plate is a meal-delivery product built around browsing meals and choosing a plan. Conscious Rise developed the Next.js customer experience and the application structure required for a complete ordering journey."],
  ...
  "eleusis-mind": {
    ...
    overview: ["Eleusis Mind is an immersive site for a consciousness research and psychedelic immersion centre. Conscious Rise developed the Framer experience with a focus on atmosphere, storytelling and clarity."],
    stack: [{ group: "Frontend", items: ["Framer"] }],
  ...
  "kris-kelly": {
    ...
    overview: ["Kris Kelly is a personal platform connecting breathwork, music and somatic practice. Conscious Rise developed the expressive Framer site and its responsive content system."],
  ...
  "meagan-perkins": {
    ...
    overview: ["Meagan Perkins’ Rooted Regeneration site presents programmes and ideas through a warm, editorial experience. Conscious Rise implemented the frontend in Framer."],
  ...
  "elite-b-car": {
    ...
    overview: ["Elite B Car is a New York chauffeur service for airport transfers, city travel, corporate transport and events. Conscious Rise built the Next.js website and connected its primary booking path to the client’s existing Limo Anywhere booking system."],
