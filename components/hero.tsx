...
export function Hero() {
  return (
    <section id="top" className="relative flex min-h-[100svh] flex-col overflow-hidden bg-[#090b16]">
      <Image
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,7,16,0.88)_0%,rgba(5,7,16,0.56)_38%,rgba(5,7,16,0.08)_72%),linear-gradient(180deg,rgba(5,7,16,0.38)_0%,transparent_35%,rgba(5,7,16,0.5)_100%)]" />

      <div className="container-x relative z-10 flex flex-1 items-start pt-36 pb-16 sm:pt-40 lg:pt-44">
        <div className="max-w-3xl">
            ...
            <Reveal delay={90}>
              <h1 className="mt-7 font-display text-[clamp(2.8rem,7vw,6.4rem)] font-semibold leading-[0.92] tracking-[-0.055em] text-[#ffffff] drop-shadow-[0_4px_30px_rgba(0,0,0,0.45)]">
                Websites that
                <br />
            ...
            <Reveal delay={170}>
              <p className="mt-7 max-w-xl text-[1.0625rem] leading-relaxed text-[rgba(255,255,255,0.78)] drop-shadow-md sm:text-lg">
            ...
            <Reveal delay={310}>
              <dl className="mt-10 flex flex-wrap items-center gap-x-10 gap-y-5 border-t border-white/20 pt-7">
                {[
                  ["5+", "years experience"],
